...
export function nadavalue_new_secret_boolean(a: number, b: number, c: number): void;
...
export function nadavalue_new_public_boolean(a: number, b: number, c: number): void;
...
export function __wbg_encodedmodulo_free(a: number): void;
...
export function secretmasker_modulo(a: number): number;
