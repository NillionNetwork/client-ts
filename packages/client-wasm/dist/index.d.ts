...
*/
  static new_secret_non_zero_integer(value: string): NadaValue;
/**
...
*/
  static new_secret_non_zero_unsigned_integer(value: string): NadaValue;
/**
...
export interface InitOutput {
  ...
  readonly nadavalue_new_secret_non_zero_integer: (a: number, b: number, c: number) => void;
  readonly nadavalue_new_secret_non_zero_unsigned_integer: (a: number, b: number, c: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h089cb3535dd8fbe9: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd01180835a937fda: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb870b5d1259d419e: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9bbab91913200b63: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hdbc9ec6d754eb0ec: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h66d0f6349ee727e6: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hf9705df32af46fe3: (a: number, b: number, c: number, d: number) => void;
