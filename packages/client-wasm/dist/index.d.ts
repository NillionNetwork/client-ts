...
export interface InitOutput {
  ...
  readonly programbindings_add_input_party: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly programbindings_add_output_party: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nadavalue_new_secret_integer: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly nadavalue_new_secret_unsigned_integer: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly nadavalue_new_secret_blob: (a: number, b: number) => number;
  readonly nadavalue_new_public_integer: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly nadavalue_new_public_unsigned_integer: (
    a: number,
    b: number,
    c: number,
  ) => void;
  ...
  readonly nillionclient_store_values: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_retrieve_value: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_update_values: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_delete_values: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_compute: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_compute_result: (
    a: number,
    b: number,
    c: number,
  ) => number;
  readonly nillionclient_retrieve_permissions: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_update_permissions: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_store_program: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly nillionclient_request_price_quote: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => number;
  readonly nillionclient_cluster_information: (
    a: number,
    b: number,
    c: number,
  ) => number;
  readonly nillionclient_enable_tracking: (
    a: number,
    b: number,
    c: number,
  ) => void;
  ...
  readonly permissions_add_retrieve_permissions: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void;
  readonly permissions_add_update_permissions: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void;
  readonly permissions_add_delete_permissions: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void;
  readonly permissions_add_compute_permissions: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly permissions_is_retrieve_allowed: (
    a: number,
    b: number,
    c: number,
  ) => number;
  readonly permissions_is_update_allowed: (
    a: number,
    b: number,
    c: number,
  ) => number;
  readonly permissions_is_delete_allowed: (
    a: number,
    b: number,
    c: number,
  ) => number;
  readonly permissions_is_compute_allowed: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4c39054f7f82e995: (
    a: number,
    b: number,
    c: number,
  ) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5666368b3099f94b: (
    a: number,
    b: number,
  ) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h9ad06f9448a06267: (
    a: number,
    b: number,
    c: number,
    d: number,
